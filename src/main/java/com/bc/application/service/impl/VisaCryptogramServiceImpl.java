...
import com.bc.utilities.EMVSessionKeyDerivator;
import com.bc.utilities.EMVUniqueDerivationKeyDerivator;
...
public class VisaCryptogramServiceImpl extends CryptogramFunctionsService<GenerateApplicationCryptogramCommand,
    ...
    public CryptogramResponse getApplicationCryptogram(GenerateApplicationCryptogramCommand command) {
        ...
        String uniqueDerivationKey = getUniqueDerivationKey(cryptogramRequest.getIssuerMasterKey(), cryptogramRequest.getPan(),
                cryptogramRequest.getPanSequenceNumber(), visaIADParser.getCryptogramVersionNumber());
        // Generate SK
        String sessionKey = getSessionKey(uniqueDerivationKey, cryptogramRequest.getApplicationTransactionCounter(),
                visaIADParser.getCryptogramVersionNumber());
        return buildResponseObjectFromDomain(generateCryptogram(cryptogramRequest, sessionKey));
    }
    /**
    ...
    protected String generateCryptogram(CryptogramRequest cryptogramRequest, String sessionKey) {
        ...
        return visaApplicationCryptogramGenerator.getVisaApplicationCryptogram(cryptogramRequest, sessionKey);
    }
    /**
